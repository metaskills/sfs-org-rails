...
class MeetupEvent
  ...
  @signedURL = 'https://api.meetup.com/2/events.json/?offset=0&format=json&limited_events=False&group_id=1068870&page=1&fields=&order=time&status=upcoming&desc=false'
